...
require_once dirname(__FILE__).'/../../../symfony/lib/helper/FormHelper.php';
require_once dirname(__FILE__).'/../../../symfony/lib/helper/JavascriptBaseHelper.php';
require_once dirname(__FILE__).'/../../../symfony/lib/helper/I18NHelper.php';
...
function _get_propel_object_list($object, $method, $options)
{
  ...
  $objects = sfPropelManyToMany::getAllObjects($object, $through_class, null, $peer_method);
...
function _get_property_from_users($object, $method, $options)
{
  // get the lists of objects
  $through_class = _get_option($options, 'through_class');
  ...
  $objects = sfPropelManyToMany::getAllObjects($object, $through_class, $criteria, $peer_method);
  $objects_associated = sfPropelManyToMany::getRelatedObjects($object, $through_class, $criteria, $peer_method);
  $ids = array_map(create_function('$o', 'return $o->getPrimaryKey();'), $objects_associated);
