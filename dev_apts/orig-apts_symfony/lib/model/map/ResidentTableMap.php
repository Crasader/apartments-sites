...
/**
 * This class defines the structure of the 'resident' table.
 *
 *
 ...
 */
class ResidentTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.ResidentTableMap';
	...
	{
	  // attributes
		$this->setName('resident');
		$this->setPhpName('Resident');
		$this->setClassname('Resident');
		$this->setPackage('lib.model');
		$this->setUseIdGenerator(true);
		// columns
		$this->addPrimaryKey('ID', 'Id', 'INTEGER', true, 10, null);
		$this->addColumn('FIRST_NAME', 'FirstName', 'VARCHAR', true, 128, '');
		$this->addColumn('LAST_NAME', 'LastName', 'VARCHAR', true, 128, '');
		$this->addColumn('PASSWORD', 'Password', 'VARCHAR', true, 255, '');
		$this->addColumn('EMAIL', 'Email', 'VARCHAR', true, 255, '');
		$this->addColumn('TENANTID', 'Tenantid', 'VARCHAR', true, 24, '');
