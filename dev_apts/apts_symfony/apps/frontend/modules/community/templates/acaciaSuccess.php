			...
			<div class="content_secondary">
				...
				jQuery(document).ready(function($) {
				 ...
				 jQuery('.poimap').gMap({
					...
					<div style="float:left; width:942px; height:319px; border:1px solid #ccc; background: #FFF;">
						<div style="float:left; width:910px; height:291px; margin:14px 0 0 14px;">
						<div style="float:left; width:910px; height:291px;" class="poimap">

						</div>
						</div>
					 </div><!-- end of feature-comm -->

					<div class="com_acc" style="float:left;">
