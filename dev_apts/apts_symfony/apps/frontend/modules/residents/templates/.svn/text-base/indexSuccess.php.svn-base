...
<div id="sec-left"> <span class="title">Resident's Center</span><br />
  ...
  <div id="res-payment">
    ...
    <div class="res-left1020">
      <div class="float-r"><a href="http://amc.ubwest.com/payment/index/id/<?php echo $property->getId()?>"><img src="/images/btn-payment.gif" alt="make a payment online" /></a></div>
...
<div id="nav">
  ...
  <div class="nav-item" title="<?php echo $property->getCity()?> Apartments For Rent - Rental Application"><a href="/uploads/properties/<?php echo $propertyTemplate->getRentalappFile();?>" target="_blank">Rental Application</a></div>
