                ...
                <div class="container">
                    ...
                    <div class="row mb-30">
                        ...
                        <div class="col-md-2">
                            <ul class="text-center">
                                ...
                                <li><a href="schedule-a-tour.asp">Schedule a Tour</a></li>
                                <li><a href="floor-plans.asp">View Available Units</a></li>
                                <li><a href="app-online.asp">Apply Online</a></li>
                            </ul>
                        </div>

                        <div class="col-md-2">
                            <ul class="text-center">
                                <li><a href="resident-portal.asp">Resident Portal</a></li>
                    ...
                    <div class="footer-text">
                        ...
                        <div class="footer-copy font-alt">
                            <img src="img/hudimg.png" width="30" height="20" alt="Equal Housing" title="Equal Housing" class="eq-house-img"> 
                        </div>
                        <!-- End Copyright -->
