...
<html lang="">
	<head>
		...
		<title>644 City Station - Contact</title>
		<!-- CSS -->
			...
			<style>
		      ...
		      #right-panel {width: 100%; height: 100%; margin-bottom: 30px}
		    </style>
	    ...
	    <script>
	      function initMap() {
	        ...
	        var map = new google.maps.Map(document.getElementById('map'), {
	          zoom: 13,
	          center: {lat: 40.771603, lng: -111.909244}
	        });
	        directionsDisplay.setMap(map);
	        directionsDisplay.setPanel(document.getElementById('right-panel'));

	        var myLatLng = {lat: 40.771603, lng: -111.909244};

	        var marker = new google.maps.Marker({
	          position: myLatLng,
	          map: map,
	          title: '644 City Station'
	        });
	        ...
	        document.getElementById(''), onChangeHandler();
	        
	      }

	      function calculateAndDisplayRoute(directionsService, directionsDisplay) {
	        var start = ''
	        var end = '644 West North Temple'
	    ...
	    <style type="text/css">
	    	label {font-size: 0.8rem; -webkit-transform: translateY(-140%); transform: translateY(-140%);}
	    </style>
		<!-- End CSS -->
	</head>
	<body id="getDirections" onload="initMap();">
		<!-- Header -->
				<header>
			<!-- Filter Modal -->
		...
		<div class="content">
			...
			<div class="page-header deep-orange darken-2">
				<div class="row container">
					<h2 class="white-text">MAP AND DIRECTIONS</h2>
				</div>
			</div>
			...
			<div class="section white">
				<div class="container">
					<div class="row">
						<div class="col s12 m6">
							<form role="form" id="form1" name="form1" method="post" class="hoverable eqheight" action="" onsubmit="onChangeHandler();">
								<div class="row">
									<div class="input-field col s12">
										<input type="text" class="" id="startAddress" name="startAddress" onFocus="geocomplete();" />
										<label for="startAddress" class="active">Please enter your starting address</label>
									</div>
								</div>
								<div class="row">
									<div class="col s12 m6">
										<button type="submit" id="find" class="btn-block btn-large waves-effect waves-light deep-orange darken-2 white-text center-align">Map It</button>
									</div>
								</div>
							</form>
						</div>
						<div class="col s12 m6">
							<div>
								<script defer src="//maps.googleapis.com/maps/api/js?libraries=places&key=AIzaSyBLraRy_WGefk7vAjJrf6cJzS9Jm-aFf1o"></script>
								<div id="map" class="eqheight"></div>			
							</div>
						</div>
					</div>
					<div class="row">
