...
<html lang="">
	<head>
		...
		<title>644 City Station - Residents</title>
		<!-- CSS -->
		...
		<div class="content">
			...
			<div class="page-header deep-orange darken-2">
				<div class="row container">
					<h2 class="white-text">Residents</h2>
				</div>
			</div>
					...
					<div class="col l4 m6">
						<div class="card hoverable">
							<div class="card-image">
								<img src="images/residents-apply.jpg">
								<span class="card-title">Apply Online</span>
							</div>
							<div class="card-content eqheight center-align">
								<a href="#" class="waves-effect waves-light btn-large blue-grey darken-4 white-text">Apply Now</a>
							</div>
						</div>
					</div>
					<div class="col l4 m6">
						<div class="card hoverable">
							<div class="card-image">
								<img src="images/residents-maint.jpg">
								<span class="card-title">Maintenance Request</span>
							</div>
							<div class="card-content eqheight center-align">
								<a href="#" class="waves-effect waves-light btn-large blue-grey darken-4 white-text">Send Maintenance Request</a>
							</div>
						</div>
					</div>
					<div class="col l4 m6">
						<div class="card hoverable">
							<div class="card-image">
								<img src="images/residents-suggestion.jpg">
								<span class="card-title">Suggestion Box</span>
							</div>
							<div class="card-content eqheight center-align">
								<a href="#" class="waves-effect waves-light btn-large blue-grey darken-4 white-text">Send a Suggestion</a>
							</div>
						</div>
					</div>
					<div class="col l4 m6">
						<div class="card hoverable">
							<div class="card-image">
								<img src="images/residents-map.jpg">
								<span class="card-title">Get Directions</span>
							</div>
							<div class="card-content eqheight center-align">
								<a href="getdirections.asp" class="waves-effect waves-light btn-large blue-grey darken-4 white-text">Map It</a>
							</div>
						</div>
					</div>
					<div class="col l4 m6">
						<div class="card hoverable">
							<div class="card-image">
								<img src="images/residents-pets.jpg">
								<span class="card-title">Review Pet Policies</span>
							</div>
							<div class="card-content eqheight center-align">
								<a href="#" class="waves-effect waves-light btn-large blue-grey darken-4 white-text">Pet Policies</a>
							</div>
						</div>
					</div>
					<div class="col l4 m6">
						<div class="card hoverable">
							<div class="card-image">
								<img src="images/residents-payment.jpg">
								<span class="card-title">Pay Online</span>
							</div>
							<div class="card-content eqheight center-align">
								<a href="#" class="waves-effect waves-light btn-large blue-grey darken-4 white-text">Pay Online</a>
							</div>
						</div>
					</div>
				</div>
