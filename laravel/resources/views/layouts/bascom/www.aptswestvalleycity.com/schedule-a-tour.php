...
<html>
    ...
    <body class="appear-animate">
        ...
        <div class="page" id="top">
            ...
            <!-- Page Title Section -->
            <section class="page-section bg-dark-alfa-30" data-background="images/page-title-bg2.jpg">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="benefit-item">
                                            ...
                                            <h3 class="benefit-title font-alt">702.566.6344</h3>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="benefit-item">
                                            ...
                                            <h3 class="benefit-title font-alt">ADDRESS</h3>
                                            <div class="benefits-descr">
                                                80 South Gibson Road<br>
                                                Henderson, NV 89012
                                            </div>
                                        </div>
                                    </div>
