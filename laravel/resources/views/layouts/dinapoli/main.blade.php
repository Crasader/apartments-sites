...
@section('meta')
        <meta name="description" content="<?php echo $entity->getMeta('description',Request::getRequestUri());?>">
        <meta name="keywords" content="<?php echo $entity->getMeta('keywords',Request::getRequestUri());?>">
        <meta charset="utf-8">
