...
abstract class BaseUser extends BaseObject  implements Persistent {
	 ...
	 * related UserPropertys from storage. If this User is new, it will return
		...
		if ($this->collUserPropertys === null) {
			if ($this->isNew()) {
			   $this->collUserPropertys = array();
				...
				$criteria->add(UserPropertyPeer::USER_ID, $this->id);
	 ...
	 */
	public function getUserPropertysJoinProperty($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(UserPeer::DATABASE_NAME);
		}
		...
		if ($this->collUserPropertys === null) {
			if ($this->isNew()) {
				...
				$this->collUserPropertys = UserPropertyPeer::doSelectJoinProperty($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this User has previously been saved, it will retrieve
	 * related UserUserRoles from storage. If this User is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collUserUserRoles === null) {
			if ($this->isNew()) {
			   $this->collUserUserRoles = array();
				...
				$criteria->add(UserUserRolePeer::USER_ID, $this->id);
	 ...
	 * actually need in User.
	 */
	public function getUserUserRolesJoinUserRole($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(UserPeer::DATABASE_NAME);
		}
		...
		if ($this->collUserUserRoles === null) {
			if ($this->isNew()) {
				...
				$this->collUserUserRoles = UserUserRolePeer::doSelectJoinUserRole($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
