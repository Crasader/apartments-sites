...
abstract class BaseUserRolePeer {
	...
	const ROLE_NAME = 'user_role.ROLE_NAME';
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (self::ID, self::ROLE_NAME, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::ROLE_NAME => 1, ),
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(UserRolePeer::ROLE_NAME);
	}
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BaseUserRolePeer', $criteria, $con);
		}
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseUserRolePeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseUserRolePeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseUserRolePeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseUserRolePeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseUserRolePeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseUserRolePeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseUserRolePeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseUserRolePeer', $values, $con, $ret);
    }
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += UserRolePeer::doOnDeleteCascade(new Criteria(UserRolePeer::DATABASE_NAME), $con);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->beginTransaction();
			$affectedRows += UserRolePeer::doOnDeleteCascade($criteria, $con);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		$objects = UserRolePeer::doSelect($criteria, $con);
		foreach ($objects as $obj) {
			...
			$criteria->add(UserUserRolePeer::USER_ROLE_ID, $obj->getId());
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseUserRolePeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
