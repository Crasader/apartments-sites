...
/**
 * Base class that represents a row from the 'photo_type' table.
 *
 * 
 *
 ...
 */
abstract class BasePhotoType extends BaseObject  implements Persistent {
	...
	/**
	 * Initializes internal state of BasePhotoType object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     PhotoType The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = PhotoTypePeer::ID;
		}
	...
	public function setName($v)
	{
		...
		if ($this->name !== $v || $this->isNew()) {
			$this->name = $v;
			$this->modifiedColumns[] = PhotoTypePeer::NAME;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = PhotoTypePeer::NUM_COLUMNS - PhotoTypePeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating PhotoType object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = PhotoTypePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BasePhotoType:delete:pre') as $callable)
			{
			...
			if ($ret) {
				PhotoTypePeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BasePhotoType:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BasePhotoType:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BasePhotoType:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				PhotoTypePeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = PhotoTypePeer::doInsert($this, $con);
					...
					$affectedRows += PhotoTypePeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = PhotoTypePeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = PhotoTypePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PhotoTypePeer::ID)) $criteria->add(PhotoTypePeer::ID, $this->id);
		if ($this->isColumnModified(PhotoTypePeer::NAME)) $criteria->add(PhotoTypePeer::NAME, $this->name);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(PhotoTypePeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of PhotoType (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     PhotoType Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     PhotoTypePeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new PhotoTypePeer();
		}
		return self::$peer;
	}
	 ...
	 * Otherwise if this PhotoType has previously been saved, it will retrieve
	 * related PropertyPhotos from storage. If this PhotoType is new, it will return
		...
		if ($this->collPropertyPhotos === null) {
			if ($this->isNew()) {
			   $this->collPropertyPhotos = array();
				...
				$criteria->add(PropertyPhotoPeer::PHOTO_TYPE_ID, $this->id);
	 ...
	 * Otherwise if this PhotoType is new, it will return
	 * an empty collection; or if this PhotoType has previously
	 * been saved, it will retrieve related PropertyPhotos from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in PhotoType.
	 */
	public function getPropertyPhotosJoinProperty($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(PhotoTypePeer::DATABASE_NAME);
		}
		...
		if ($this->collPropertyPhotos === null) {
			if ($this->isNew()) {
				...
				$this->collPropertyPhotos = PropertyPhotoPeer::doSelectJoinProperty($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	...
	{
	  if (!$callable = sfMixer::getCallable('BasePhotoType:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BasePhotoType::%s', $method));
	  }
