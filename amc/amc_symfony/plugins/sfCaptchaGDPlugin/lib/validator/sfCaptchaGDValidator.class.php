...
class sfCaptchaGDValidator extends sfValidatorString
{
  ...
  { 
    ...
    if (sfContext::getInstance()->getUser()->getAttribute('captcha', NULL) != 
      $clean
      //sfContext::getInstance()->getRequest()->getParameter('captcha', NULL)
      )
    {
      sfContext::getInstance()->getUser()->setAttribute('captcha', NULL);
      throw new sfValidatorError($this, 'sadfsinvalid', array('value' => $value));
    }
