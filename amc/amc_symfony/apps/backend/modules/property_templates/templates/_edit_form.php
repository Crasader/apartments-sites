...
<div class="form-row">
  <?php echo label_for('property_template[online_application_url]', __($labels['property_template{online_application_url}']), '') ?>
  <div class="content<?php if ($sf_request->hasError('property_template{online_application_url}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('property_template{online_application_url}')): ?>
    <?php echo form_error('property_template{online_application_url}', array('class' => 'form-error-msg')) ?>
  <?php endif; ?>

  <?php $value = object_textarea_tag($property_template, 'getOnlineApplicationUrl', array (
  'size' => '80x10',
  'control_name' => 'property_template[online_application_url]',
)); echo $value ? $value : '&nbsp;' ?>
    </div>
</div>

<div class="form-row">
  <?php echo label_for('property_template[src3dtour]', __($labels['property_template{src3dtour}']), '') ?>
  <div class="content<?php if ($sf_request->hasError('property_template{src3dtour}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('property_template{src3dtour}')): ?>
    <?php echo form_error('property_template{src3dtour}', array('class' => 'form-error-msg')) ?>
  <?php endif; ?>

  <?php $value = object_textarea_tag($property_template, 'getSrc3dtour', array (
  'size' => '80x10',
  'control_name' => 'property_template[src3dtour]',
)); echo $value ? $value : '&nbsp;' ?>
    </div>
</div>

<div class="form-row">
  <?php echo label_for('property_template[home_photo_desc]', __($labels['property_template{home_photo_desc}']), '') ?>
  <div class="content<?php if ($sf_request->hasError('property_template{home_photo_desc}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('property_template{home_photo_desc}')): ?>
    <?php echo form_error('property_template{home_photo_desc}', array('class' => 'form-error-msg')) ?>
  <?php endif; ?>

  <?php $value = object_textarea_tag($property_template, 'getHomePhotoDesc', array (
  'size' => '80x10',
  'control_name' => 'property_template[home_photo_desc]',
)); echo $value ? $value : '&nbsp;' ?>
    </div>
</div>

<div class="form-row">
  <?php echo label_for('property_template[gmap_key]', __($labels['property_template{gmap_key}']), '') ?>
  <div class="content<?php if ($sf_request->hasError('property_template{gmap_key}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('property_template{gmap_key}')): ?>
    <?php echo form_error('property_template{gmap_key}', array('class' => 'form-error-msg')) ?>
  <?php endif; ?>

  <?php $value = object_textarea_tag($property_template, 'getGMapKey', array (
  'size' => '80x10',
  'control_name' => 'property_template[gmap_key]',
)); echo $value ? $value : '&nbsp;' ?>
    </div>
</div>

<div class="form-row">
  <?php echo label_for('property_template[e_brochure]', __($labels['property_template{e_brochure}']), '') ?>
  <div class="content<?php if ($sf_request->hasError('property_template{e_brochure}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('property_template{e_brochure}')): ?>
    <?php echo form_error('property_template{e_brochure}', array('class' => 'form-error-msg')) ?>
  <?php endif; ?>

  <?php $value = object_admin_input_file_tag($property_template, 'getEBrochure', array (
  'control_name' => 'property_template[e_brochure]',
  'include_link' => 'properties',
  'include_remove' => true,
)); echo $value ? $value : '&nbsp;' ?>
    </div>
