...
<div class="form-row">
  <?php echo label_for('property_floorplan[availability_link]', __($labels['property_floorplan{availability_link}']), 'class="required" ') ?>
  <div class="content<?php if ($sf_request->hasError('property_floorplan{availability_link}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('property_floorplan{availability_link}')): ?>
    <?php echo form_error('property_floorplan{availability_link}', array('class' => 'form-error-msg')) ?>
  <?php endif; ?>

  <?php $value = object_input_tag($property_floorplan, 'getAvailabilityLink', array (
  'size' => 80,
  'control_name' => 'property_floorplan[availability_link]',
)); echo $value ? $value : '&nbsp;' ?>
    </div>
</div>

<div class="form-row">
  <?php echo label_for('property_floorplan[display_order]', __($labels['property_floorplan{display_order}']), 'class="required" ') ?>
  <div class="content<?php if ($sf_request->hasError('property_floorplan{display_order}')): ?> form-error<?php endif; ?>">
  <?php if ($sf_request->hasError('property_floorplan{display_order}')): ?>
    <?php echo form_error('property_floorplan{display_order}', array('class' => 'form-error-msg')) ?>
  <?php endif; ?>

  <?php $value = object_input_tag($property_floorplan, 'getDisplayOrder', array (
  'size' => 7,
  'control_name' => 'property_floorplan[display_order]',
)); echo $value ? $value : '&nbsp;' ?>
    </div>
</div>
