...
<?php echo form_tag('property_templates/list', array('method' => 'get')) ?>
  ...
  <ul class="sf_admin_actions">
    <li><?php echo button_to(__('reset'), 'property_templates/list?filter=filter', 'class=sf_admin_action_reset_filter') ?></li>
