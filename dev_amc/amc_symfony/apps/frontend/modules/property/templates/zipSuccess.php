        ...
        <div class="listing">
          ...
          <div class="listing-txt">
            <div class="listing-right">
              ...
              <br /><br />
              <div class="floatr"><a href="<?php echo url_for('property/list?view=detail&id='.$property->id) ?>" title="Apartments <?php echo $property->city ?>, Apartments <?php echo $property->state_name ?>"><img src="/images/btn-viewproperty.gif" border="0" /></a></div>
            </div>
            <div class="listing-title"><a class="listing-title" href="<?php echo url_for('property/list?view=detail&id='.$property->id) ?>" title="Apartments <?php echo $property->city ?>, Apartments <?php echo $property->state_name ?>"><?php echo $property->name ?></a></div><br />
