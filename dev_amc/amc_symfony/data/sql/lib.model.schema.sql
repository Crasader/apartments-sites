...
(
	...
	`bathrooms` INTEGER(10) default  NOT NULL,
...
(
	...
	`zip_code_type` VARCHAR(32)  NOT NULL,
	...
	`decommisioned` VARCHAR(12)  NOT NULL,
	`tax_returns_filed` INTEGER(11),
	`estimated_population` INTEGER(11),
	`total_wages` INTEGER(11),
