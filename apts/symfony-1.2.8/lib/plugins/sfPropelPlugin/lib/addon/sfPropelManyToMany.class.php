...
class sfPropelManyToMany
{
  ...
  public static function getAllObjects($object, $middleClass, $relatedColumn = '', $criteria = null, $peerMethod = 'doSelect')
  {
    if (null === $criteria)
    {
    ...
    return call_user_func(array(constant($relatedClass.'::PEER'), $peerMethod), $criteria);
  }
