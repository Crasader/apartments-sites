...
class PropertyTemplateTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('E_BROCHURE', 'EBrochure', 'VARCHAR', false, 50, null);
		$this->addColumn('SRC_3DTOUR', 'Src3dtour', 'LONGVARCHAR', false, null, null);
		$this->addColumn('HOME_PHOTO_DESC', 'HomePhotoDesc', 'LONGVARCHAR', false, null, null);
		$this->addColumn('GMAP_KEY', 'GmapKey', 'LONGVARCHAR', false, null, null);
		// validators
	} // initialize()
