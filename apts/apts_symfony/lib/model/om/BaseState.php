...
abstract class BaseState extends BaseObject  implements Persistent {
	...
	public function setOrderBy($v)
	{
		...
		if ($this->order_by !== $v || $this->isNew()) {
			$this->order_by = $v;
			$this->modifiedColumns[] = StatePeer::ORDER_BY;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->order_by = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
			$this->resetModified();
			...
			return $startcol + 5; // 5 = StatePeer::NUM_COLUMNS - StatePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(StatePeer::ORDER_BY)) $criteria->add(StatePeer::ORDER_BY, $this->order_by);
	 ...
	 * actually need in State.
	 */
	public function getPropertysJoinCorporateGroup($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(StatePeer::DATABASE_NAME);
		}
		...
		if ($this->collPropertys === null) {
			if ($this->isNew()) {
				...
				$this->collPropertys = PropertyPeer::doSelectJoinCorporateGroup($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
