...
abstract class BaseProperty extends BaseObject  implements Persistent {
	...
	public function setCorporateGroupId($v)
	{
		...
		if ($this->corporate_group_id !== $v || $this->isNew()) {
			...
			$this->modifiedColumns[] = PropertyPeer::CORPORATE_GROUP_ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->corporate_group_id = ($row[$startcol + 22] !== null) ? (int) $row[$startcol + 22] : null;
			$this->resetModified();
			...
			return $startcol + 23; // 23 = PropertyPeer::NUM_COLUMNS - PropertyPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[22] => $this->getCorporateGroupId(),
		);
		return $result;
	}
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[22], $arr)) $this->setCorporateGroupId($arr[$keys[22]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PropertyPeer::CORPORATE_GROUP_ID)) $criteria->add(PropertyPeer::CORPORATE_GROUP_ID, $this->corporate_group_id);
	...
	public function getCorporateGroup(PropelPDO $con = null)
	{
		if ($this->aCorporateGroup === null && ($this->corporate_group_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aCorporateGroup->addPropertys($this);
			 */
		}
	 ...
	 */
	public function getContactsJoinCorporateGroup($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(PropertyPeer::DATABASE_NAME);
		}
		...
		if ($this->collContacts === null) {
			if ($this->isNew()) {
				...
				$this->collContacts = ContactPeer::doSelectJoinCorporateGroup($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
