...
abstract class BasePropertyFloorplan extends BaseObject  implements Persistent {
	...
	public function setDisplayOrder($v)
	{
		...
		if ($this->display_order !== $v || $this->isNew()) {
			...
			$this->modifiedColumns[] = PropertyFloorplanPeer::DISPLAY_ORDER;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->display_order = ($row[$startcol + 11] !== null) ? (int) $row[$startcol + 11] : null;
			$this->resetModified();
			...
			return $startcol + 12; // 12 = PropertyFloorplanPeer::NUM_COLUMNS - PropertyFloorplanPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[11], $arr)) $this->setDisplayOrder($arr[$keys[11]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PropertyFloorplanPeer::DISPLAY_ORDER)) $criteria->add(PropertyFloorplanPeer::DISPLAY_ORDER, $this->display_order);
