...
abstract class BaseStatus extends BaseObject  implements Persistent {
	 ...
	 * related Propertys from storage. If this Status is new, it will return
		...
		if ($this->collPropertys === null) {
			if ($this->isNew()) {
			   $this->collPropertys = array();
				...
				$criteria->add(PropertyPeer::STATUS_ID, $this->id);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Status has previously been saved, it will retrieve
	 * related Residents from storage. If this Status is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collResidents === null) {
			if ($this->isNew()) {
			   $this->collResidents = array();
				...
				$criteria->add(ResidentPeer::STATUS_ID, $this->id);
	 ...
	 * actually need in Status.
	 */
	public function getResidentsJoinProperty($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(StatusPeer::DATABASE_NAME);
		}
		...
		if ($this->collResidents === null) {
			if ($this->isNew()) {
				...
				$this->collResidents = ResidentPeer::doSelectJoinProperty($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
