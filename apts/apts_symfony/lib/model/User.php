...
class User extends BaseUser
{
  ...
  public function getUserPropertiesList() {
    $user_property_names = array();
    foreach ($this->getUserPropertys() as $user_property) {
            $user_property_names[] =  $user_property->getProperty()->getCode().' - '.$user_property->getProperty()->getName();
    }
