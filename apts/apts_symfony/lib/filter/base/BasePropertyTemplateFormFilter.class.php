...
abstract class BasePropertyTemplateFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'online_application_url'     => new sfWidgetFormFilterInput(),
      'e_brochure'                 => new sfWidgetFormFilterInput(),
      'src_3dtour'                 => new sfWidgetFormFilterInput(),
      'home_photo_desc'            => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'online_application_url'     => new sfValidatorPass(array('required' => false)),
      'e_brochure'                 => new sfValidatorPass(array('required' => false)),
      'src_3dtour'                 => new sfValidatorPass(array('required' => false)),
      'home_photo_desc'            => new sfValidatorPass(array('required' => false)),
