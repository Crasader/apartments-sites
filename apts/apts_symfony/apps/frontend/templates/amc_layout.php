...
<div id="primaryContainer" class="primaryContainer clearfix">
  ...
  <div id="headerwrap" class="clearfix">
    ...
    <div id="hdrcontain" class="clearfix">
        ...
        <div id="topbar" class="clearfix"><a href="<?php echo url_for('floorplans/index')?>">Availability</a>
        &nbsp;&nbsp;&nbsp;<a class="popup" href="<?php echo url_for('/contact/min/index')?>">Schedule a Tour</a> 
    ...
    <a class="fancybox fancybox.iframe" href="<?php echo url_for('/contact/min/index')?>">Schedule a Tour</a><br /><!--class="fancybox fancybox.iframe"-->
    ...
    <?php if (has_slot('rentalappm')): ?>
          <?php include_slot('rentalappm') ?><br />
        <?php endif; ?>
  ...
  <div id="text4"> <span id="textspan1"><a href="<?php echo url_for('privacypolicy/index')?>">Privacy Policy</a> &nbsp; | &nbsp; <a href="<?php echo url_for('termsofuse/index')?>">Terms of Use</a> &nbsp; | &nbsp; <a href="http://translate.google.com/translate?hl=en&sl=en&tl=es&u=<?php echo $_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']?>">Translate</a></span><span id="textspan2"><br />
    </span> <span id="textspan3"> © Copyright <?php echo date('Y');?></span><br />
    <br />
  ...
  <div id="footer"> <a href="<?php echo url_for('privacypolicy/index')?>">Privacy Policy</a> &nbsp; | &nbsp; <a href="<?php echo url_for('termsofuse/index')?>">Terms of Use</a> &nbsp; | &nbsp; <a href="http://translate.google.com/translate?hl=en&sl=en&tl=es&u=<?php echo $_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']?>">Translate</a> &nbsp; | &nbsp;  © Copyright <?php echo date('Y');?>
    <div id="eoh"><img src="/images/resp/eho.svg" /></div>
  </div>
