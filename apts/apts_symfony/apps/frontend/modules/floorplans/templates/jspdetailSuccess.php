    ...
    <div class="content_container_margins">
        ...
        <div id="floorplan" class="clearfix">
          ...
          <div class="floorplancell cell2">
            <h2>DEPOSIT</h2>
            <p>
            <?php if(!empty($row['floorplan']['deposit'])):?>
      ...
      <?php if($propertyTemplate->getOnlineApplicationUrl() != ''):?>
      <div class="detailbox"><a href="<?php echo $propertyTemplate->getOnlineApplicationUrl();?>" target="_blank" class="button float-right clearfix">Apply Now</a></div>
      <?php endif;?>
        <?php /*<div class="floorplan_grid">
        <?php foreach($property->getPropertyFloorPlans() as $floorplan):?>
