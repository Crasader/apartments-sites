  ...
  <div class="content_inner">
    <div class="content_params">
      ...
      <div class="content_secondary">
        ...
        <div class="floorplancell cell5"><a href="/uploads/floorplans/<?php echo $arrFloorPlans['floorplan']['image'];?>" class="fancybox"><img src="/uploads/floorplans/169/<?php echo $arrFloorPlans['floorplan']['image'];?>" /></a>
