...
<div id="availcontain" class="clearfix">
    <div class="row">
      <div id="availtitle">
        <h1>Check out what's available here at <?php echo $property->getName()?> apartments</h1>
        <div id="move-in"><?php /*
          <form id="contactform">
            <ul >
              <li>
    ...
    <div id="floorplan" class="clearfix">
      ...
      <div class="floorplancell cell1">
        <h2>RENT</h2>
        <p><?php echo $arrFloorPlans['floorplan']['price'];?></p>
      </div>
      <div class="floorplancell cell2">
        <h2>DEPOSIT</h2>
        <p><?php echo $arrFloorPlans['floorplan']['deposit'];?></p>
      </div>
      ...
      <div class="floorplancell cell5"><a href="/uploads/floorplans/<?php echo $arrFloorPlans['floorplan']['image'];?>" class="fancybox"><img src="/uploads/floorplans/169/<?php echo $arrFloorPlans['floorplan']['image'];?>" alt="<?php echo $arrFloorPlans['floorplan']['name'];?>" title="<?php echo $arrFloorPlans['floorplan']['name'];?>" /></a>
        <div class="floorplan-linkbox"><a href="/uploads/floorplans/<?php echo $arrFloorPlans['floorplan']['image'];?>" class="fancybox">Floor Plan »</a></div>
      </div>
    </div>
  ...
  <?php
    ...
    <div id="floorplan remove-margin clearfix">
      ...
      <div class="floorplandetailcell detailcell3 <?php echo $rowColor;?>">
        <?php if(in_array($property->getCode(),array('181LYR'))):?>
        <p>&nbsp;</p>
        <?php else:?>
  ...
  <?php if($propertyTemplate->getOnlineApplicationUrl() != ''):?>
  <div class="detailbox"><a href="" target="_blank" class="button float-right clearfix" id="applynow">Apply Now</a></div>
  <?php endif;?>

 <div id="CTA" class="clearfix">
  <div id="checkitout">
    <h1><a href="<?php echo url_for('contact/index')?>">Schedule a Tour</a></h1>
  </div>
...
<?php end_slot() ?>
<script>
var url = "<?php echo $propertyTemplate->getOnlineApplicationUrl();?>";
$('#applynow').click(function(event){
   event.preventDefault();
    ...
    if (undefined != value){
      window.open (url+"&unitno="+value,"mywindow","menubar=1,resizable=1");
      //window.location.href=url+"&unitno="+value;
    } else {
