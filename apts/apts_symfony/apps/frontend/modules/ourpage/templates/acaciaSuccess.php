	...
	<div class="content_inner">
		<div class="content_params">
			...
			<div class="page_title_shell">
				<div style="width:230px;" class="page_title_params_secondary">
					<?php echo strtoupper($propertyTemplate->getCustomPageName())?>
				</div>
			</div>
		...
		<div class="header_right_container">
			...
			<div class="header_right_nav">
				...
				<?php if($propertyTemplate->getCustomPageName() != ''):?>
					<a class="nav_item active" href="<?php echo url_for('ourpage/'.$propertyTemplate->getCustomPagePermaLink())?>"><?php echo strtoupper($propertyTemplate->getCustomPageName())?></a>
				<?php endif;?>
