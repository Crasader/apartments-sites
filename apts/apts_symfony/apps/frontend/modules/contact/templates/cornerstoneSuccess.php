              ...
              <div class="generic_container">
                <div class="generic_container_params">
                  ...
                  <div class="contact_item">
                    <img src="/images/cornerstone/icon_address.png" /><br />
                    <strong class="contact_strong">Address</strong><br />
                    <span><?php echo $property->getAddress()?><br /><?php echo $property->getCity()?>, <?php echo $property->getState()->getName()?> <?php echo $property->getZip()?></span>
                  </div>


                  <div class="contact_item">
                    <img src="/images/cornerstone/icon_telephone.png" /><br />
                    <strong class="contact_strong">Telephone</strong><br />
                    <span><?php echo $property->getPhone()?></span>
                  </div>

                  <div class="contact_item">
                    <img src="/images/cornerstone/icon_email.png" /><br />
                    <strong class="contact_strong">Email</strong><br />
                    <span><a href="<?php echo url_for('contact/form')?>"><img src="/images/cornerstone/btn_schedule_tour_light.png"></a></span>
                  </div>

                  <div class="contact_item">
                    <img src="/images/cornerstone/icon_businesshours.png" /><br />
                    <strong class="contact_strong">Business Hours</strong><br />
                    <span><?php echo nl2br($property->getHours())?></span>
                  </div>
