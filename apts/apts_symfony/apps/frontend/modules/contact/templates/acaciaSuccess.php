		...
		<div class="content_params">
			...
			<form action="<?php echo url_for('contact/min'); ?>" method="post">
				...
				<div id="contact-form">
					...
					<div class="contact-form-txt"><span id="captchaMessage" style="color:#cc2424" /></span></div>
					<div class="contact-form-txt"><div class="g-recaptcha" data-sitekey="6LcqTRYUAAAAAHtSD4dB8z6hvKGd46EIFZCtS94-"></div></div>
