  ...
  <div class="content_container_params">
    <div class="content_container_margins">
      ...
      <div class="login-card">
        ...
        <?php endif; ?>
        <h2>Forgot your password? Please enter your User ID and we will reset your account and email you a new password to the email address you registered with at move-in.</h2>
        <br />
