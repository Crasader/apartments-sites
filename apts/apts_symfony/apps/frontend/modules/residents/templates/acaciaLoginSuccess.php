  ...
  <div class="content_inner">
    <div class="content_params">
      ...
      <?php if($form->hasErrors()): ?>
          ...
          <?php endif; ?>          <form action="<?php url_for('residents/login'); ?>" method="post">
            <div class="">Username:</div>
            <div class=""><?php echo $form['email']->render(array('size' => '20')) ?></div>
            <br />
            <div class="">Password:</div>
            <div class=""><?php echo $form['password']->render(array('size' => '20')) ?></div>
            <br />
            <div class="">&nbsp;</div>
            <div class=""><input name="submit" type="submit" value="Submit"  class="login-submit"  /></div>

            <br />
        <div class=""><a href="<?php echo url_for("residents/forgotpassword")?>">forgot password?</a></div>
